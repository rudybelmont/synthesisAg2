    ...
    AppComponent = __decorate([
        core_1.Component({
            ...
            providers: [
                ...
                synthesisItem_service_1.SynthesisItemService,
                synthesisMaterial_service_1.SynthesisMaterialService
            ]
        }),
        router_deprecated_1.RouteConfig([
            ...
            },
            {
                path: '/detail/:id',
                name: 'MaterialDetail',
                component: material_detail_component_1.MaterialDetailComponent
            },
            {
                path: '/material',
                name: 'Material',
                component: material_component_1.MaterialsComponent
            }
        ]), 
