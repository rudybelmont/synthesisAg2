...
var SynthesisService = (function () {
    function SynthesisService(http) {
        this.http = http;
        this.materialsUrl = 'http://localhost:3000/materials'; // URL to web api
        this.mainItemsUrl = 'http://localhost:3000/items';
    }
    SynthesisService.prototype.getMaterials = function () {
        return this.http.get(this.materialsUrl + '.json')
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    SynthesisService.prototype.getMainItems = function () {
        return this.http.get(this.mainItemsUrl + '.json')
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    SynthesisService.prototype.getMaterial = function (id) {
        return this.getMaterials()
            .then(function (materials) { return materials.filter(function (material) { return material.id === id; })[0]; });
    };
    SynthesisService.prototype.save = function (material) {
        if (material.id) {
            return this.put(material);
        }
        return this.post(material);
    };
    SynthesisService.prototype.delete = function (material) {
    ...
    // Add new Material
    SynthesisService.prototype.post = function (material) {
        var headers = new http_1.Headers({
    ...
    SynthesisService.prototype.put = function (material) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        var url = this.materialsUrl + "/" + material.id + ".json";
        return this.http
    ...
    SynthesisService.prototype.handleError = function (error) {
